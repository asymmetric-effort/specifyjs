...
describe('RadioGroup', () => {
  describe('happy paths', () => {
    it('renders with defaults', () => {
      const el = render(createElement(RadioGroup, { options: OPTIONS, value: 'red', onChange: fn(), name: 'color' }));
      const group = el.querySelector('[role="radiogroup"]');
      expect(group).toBeTruthy();
    });

    it('renders controlled value', () => {
      const el = render(createElement(RadioGroup, { options: OPTIONS, value: 'green', onChange: fn(), name: 'color' }));
    ...
    it('displays label', () => {
      const el = render(createElement(RadioGroup, { options: OPTIONS, value: 'red', onChange: fn(), name: 'color', label: 'Favorite Color' }));
      expect(el.textContent).toContain('Favorite Color');
    });

    it('displays error message', () => {
      const el = render(createElement(RadioGroup, { options: OPTIONS, value: '', onChange: fn(), name: 'color', error: 'Select one' }));
  ...
  describe('sad paths', () => {
    ...
    it('renders with empty value', () => {
      const el = render(createElement(RadioGroup, { options: OPTIONS, value: '', onChange: fn(), name: 'color' }));
      const radios = el.querySelectorAll('input[type="radio"]');
    ...
    it('renders with empty options', () => {
      const el = render(createElement(RadioGroup, { options: [], value: '', onChange: fn(), name: 'color' }));
      const group = el.querySelector('[role="radiogroup"]');
      expect(group).toBeTruthy();
    });
    ...
    it('disables individual option', () => {
      ...
      const el = render(createElement(RadioGroup, { options: opts, value: 'a', onChange: fn(), name: 'test' }));
      const radios = el.querySelectorAll('input[type="radio"]');
  ...
  describe('interaction', () => {
    ...
    it('supports horizontal direction', () => {
      const el = render(createElement(RadioGroup, { options: OPTIONS, value: 'red', onChange: fn(), name: 'color', direction: 'horizontal' }));
      const group = el.querySelector('[role="radiogroup"]') as HTMLElement;
