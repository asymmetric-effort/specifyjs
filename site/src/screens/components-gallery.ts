...
function WordCloudDemo() {
  return createElement(WordCloud, {
    words: [
      { text: "SpecifyJS", weight: 100 },
      { text: "TypeScript", weight: 80 },
      { text: "Components", weight: 70 },
      { text: "SVG", weight: 60 },
      { text: "Rendering", weight: 55 },
      { text: "Hooks", weight: 50 },
      { text: "Router", weight: 45 },
      { text: "State", weight: 40 },
      { text: "Virtual DOM", weight: 38 },
      { text: "Context", weight: 35 },
      { text: "Effects", weight: 30 },
      { text: "Refs", weight: 28 },
      { text: "Memo", weight: 25 },
      { text: "Lazy", weight: 22 },
      { text: "Portal", weight: 20 },
      { text: "Suspense", weight: 18 },
    ],
    width: 260,
    height: 160,
    minFontSize: 10,
