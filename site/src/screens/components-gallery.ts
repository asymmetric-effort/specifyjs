...
import { GeoMap, generateUSMapOutline } from '../../../components/viz/geo-map/src/index';
...
function preview(title: string, comp: () => ReturnType<typeof createElement>, sourceDir?: string) {
  return createElement(PreviewCard, { title, component: comp, sourceDir });
}

function PreviewCard(props: { title: string; component: () => ReturnType<typeof createElement>; sourceDir?: string }) {
      ...
      createElement('span', { style: { display: 'flex', alignItems: 'center', gap: '8px' } },
        ...
        props.sourceDir
          ? createElement('a', {
              ...
              style: { fontSize: '11px', color: '#94a3b8', textDecoration: 'none', opacity: '0.7' },
            }, '\ud83d\udcbb')
          : null,
      ),
...
export function ComponentsGallery() {
  ...
  return createElement(
    ...
    accordionSection('Form Components', '17 components', openSection, toggle, [
      ...
      preview('Number Spinner', NumberSpinnerDemo, 'components/form/number-spinner'),
    ...
    accordionSection('Data Display', '8 components', openSection, toggle, [
      ...
      preview('Virtual Scroll', VirtualScrollDemo, 'components/data/virtual-scroll'),
      preview('Digital Clock', DigitalClockDemo, 'components/data/digital-clock'),
    ...
    accordionSection('Feedback', '3 components', openSection, toggle, [
      ...
      preview('Progress Bar', ProgressBarDemo, 'components/feedback/progress-bar'),
    ...
    accordionSection('Layout', '9 components', openSection, toggle, [
      ...
      preview('Flex Container', FlexContainerDemo, 'components/layout/flex-container'),
      preview('Grid', GridDemo, 'components/layout/grid'),
      preview('Panel', PanelDemo, 'components/layout/panel'),
      preview('Scroll Container', ScrollContainerDemo, 'components/layout/scroll-container'),
    ...
    accordionSection('Charts & Graphs', '12 components', openSection, toggle, [
      ...
      preview('Scatter Plot', ScatterPlotDemo, 'components/viz/2D-cartesian-raw'),
    ...
    accordionSection('Data & Analytics', '9 components', openSection, toggle, [
      ...
      preview('Calendar Heat Map', CalendarHeatMapDemo, 'components/viz/calendar-heat-map'),
    ...
    accordionSection('Hierarchical & Relational', '9 components', openSection, toggle, [
      ...
      preview('Force-Directed Graph', ForceGraphDemo, 'components/viz/force-graph'),
      preview('Partition Diagram', PartitionDemo, 'components/viz/partition'),
      preview('Decomposition Tree', DecompositionTreeDemo, 'components/viz/decomposition-tree'),
    ...
    accordionSection('Mathematical', '3 components', openSection, toggle, [
      preview('Cartesian Graph (4-leaf Rose)', CartesianRoseDemo, 'components/viz/2D-cartesian-raw'),
      preview('Complex Plane (Mandelbrot)', MandelbrotDemo, 'components/viz/2D-complex-graph'),
      preview('Polar Graph (3-leaf Rose)', PolarRoseDemo, 'components/viz/2D-polar-graph'),
    ]),
...
function ToggleDemo() {
  ...
  return createElement(Toggle, { checked: on, onChange: setOn, label: on ? 'On' : 'Off' });
}

function TextInputDemo() {
  const [value, setValue] = useState('');
  return createElement('div', null,
    createElement(TextField, { value, onChange: setValue, placeholder: 'Type something...', label: 'Text Input' }),
...
function CheckboxDemo() {
  ...
  return createElement(Checkbox, { checked, onChange: setChecked, label: checked ? 'Checked' : 'Unchecked' });
}
...
function NumberSpinnerDemo() {
  ...
  return createElement(NumberSpinner, { value: n, onChange: setN, min: -100, max: 100, label: 'Counter' });
}
...
function BadgeDemo() {
  ...
  return createElement('div', { style: { display: 'flex', alignItems: 'center', gap: '16px' } },
    createElement(Badge, { count, color: '#ef4444' },
      createElement('span', { style: { fontSize: '20px' } }, '\ud83d\udce8'),
    ),
    createElement(Button, { onClick: () => setCount(count + 1), size: 'sm' }, '+1'),
...
function TagDemo() {
  ...
  return createElement('div', { style: { display: 'flex', gap: '6px', flexWrap: 'wrap' } },
    ...tags.map(tag =>
      createElement(Tag, { key: tag, label: tag, color: '#3b82f6', variant: 'subtle', removable: true, onRemove: () => setTags(tags.filter(t => t !== tag)) }),
    ),
  );
}
...
function AvatarDemo() {
  return createElement('div', { style: { display: 'flex', gap: '8px' } },
    ...
    createElement(Avatar, { name: 'Asymmetric Effort', fallbackColor: '#10b981' }),
...
function AlertDemo() {
  ...
  if (!visible) return createElement(Button, { onClick: () => setVisible(true) }, 'Show Alert');
  return createElement(Alert, { type: 'info', message: 'Informational alert built with SpecifyJS.', closable: true, onClose: () => setVisible(false) });
}
...
function ProgressBarDemo() {
  ...
  return createElement('div', null,
    ...
    createElement('div', { style: { display: 'flex', gap: '8px', marginTop: '8px' } },
      createElement(Button, { onClick: () => setValue(Math.max(0, value - 10)), size: 'sm' }, '-10'),
      createElement('span', { style: { fontSize: '13px', color: '#64748b' } }, `${value}%`),
      createElement(Button, { onClick: () => setValue(Math.min(100, value + 10)), size: 'sm' }, '+10'),
    ),
  );
}
...
function TabsDemo() {
  ...
  return createElement(Tabs, {
    ...
    variant: 'line',
    tabs: [
      { id: 'overview', label: 'Overview', content: createElement('div', { style: { fontSize: '14px', color: '#64748b', padding: '8px 0' } }, 'Content for Overview tab.') },
      { id: 'details', label: 'Details', content: createElement('div', { style: { fontSize: '14px', color: '#64748b', padding: '8px 0' } }, 'Content for Details tab.') },
      { id: 'settings', label: 'Settings', content: createElement('div', { style: { fontSize: '14px', color: '#64748b', padding: '8px 0' } }, 'Content for Settings tab.') },
    ],
  });
}
...
function PaginationDemo() {
  ...
  return createElement(Pagination, { total: 50, pageSize: 10, currentPage: page, onChange: setPage });
}
...
function CardDemo() {
  return createElement(Card, {
    ...
    createElement('p', { style: { fontSize: '13px', color: '#64748b' } }, 'Card body content goes here. Cards support titles, images, footers, and hover effects.'),
  );
}

function CounterDemo() {
  const [count, setCount] = useState(0);
  return createElement(FlexContainer, { gap: '12px', alignItems: 'center' },
    createElement(Button, { onClick: () => setCount((c: number) => c - 1), size: 'md' }, '-'),
...
function FilterListDemo() {
  ...
  return createElement('div', null,
    createElement(TextField, { value: filter, onChange: setFilter, placeholder: 'Filter fruits...', label: 'Filter' }),
    createElement(ListView, {
      items: filtered,
      keyExtractor: (item: unknown) => item as string,
      renderItem: (item: unknown) => createElement('span', { style: { fontSize: '14px' } }, item as string),
      divider: true,
...
function LineGraphDemo() {
  return createElement(LineGraph, {
    data: [
      { x: 0, y: 20 }, { x: 1, y: 45 }, { x: 2, y: 30 }, { x: 3, y: 65 },
      { x: 4, y: 50 }, { x: 5, y: 80 }, { x: 6, y: 55 },
    ],
    width: 240,
    height: 120,
    showPoints: true,
...
function PieChartDemo() {
  return createElement(PieGraph, {
    ...
    showLabels: true, showValues: true, showLegend: true,
...
function ForceGraphDemo() {
  return createElement(ForceGraph, {
    ...
    edges: [
      ...
      { source: 'E', target: 'A' }, { source: 'A', target: 'C' },
      { source: 'B', target: 'D' },
    ],
...
function ScatterPlotDemo() {
  return createElement(CartesianGraph2D, {
    ...
    pointRadius: 4, pointColor: '#3b82f6',
  });
}
...
function ColorPickerDemo() {
  ...
  return createElement(ColorPicker, { value: color, onChange: setColor, label: 'Pick a color' });
}

function DatePickerDemo() {
  const [value, setValue] = useState('2026-04-28');
  return createElement(DatePicker, { value, onChange: setValue, label: 'Select date' });
}
...
function TimePickerDemo() {
  ...
  return createElement('div', { style: { display: 'flex', flexDirection: 'column', gap: '16px' } },
    createElement(TimePicker, { value: time12, onChange: setTime12, format: '12h', label: '12-hour (AM/PM)' }),
    createElement(TimePicker, { value: time24, onChange: setTime24, format: '24h', label: '24-hour clock' }),
    createElement(TimePicker, { value: timeTz, onChange: setTimeTz, format: '24h', showSeconds: true, showTimezone: true, timezone: tz, onTimezoneChange: setTz, label: 'With seconds + timezone' }),
  );
}

function FileUploadDemo() {
  return createElement(FileUpload, { onChange: () => {}, multiple: true, label: 'Upload Files', helpText: 'Drag and drop or click to select' });
}

function MultilineDemo() {
  const [text, setText] = useState('');
  return createElement(MultilineField, { value: text, onChange: setText, placeholder: 'Type your message...', maxLength: 200, showCount: true, label: 'Message', rows: 4 });
}

function TextEditorDemo() {
  return createElement(TextEditor, {
    value: 'Select <b>text</b> and format with the toolbar. Try <i>italic</i>, <u>underline</u>, and <s>strikethrough</s>.',
...
function MenuBarDemo() {
  return createElement(Menubar, {
    menus: [
      { label: 'File', items: [{ id: 'new', label: 'New' }, { id: 'open', label: 'Open' }, { id: 'save', label: 'Save' }, { id: 'export', label: 'Export' }] },
      { label: 'Edit', items: [{ id: 'undo', label: 'Undo' }, { id: 'redo', label: 'Redo' }, { id: 'cut', label: 'Cut' }, { id: 'copy', label: 'Copy' }, { id: 'paste', label: 'Paste' }] },
      { label: 'View', items: [{ id: 'zoomin', label: 'Zoom In' }, { id: 'zoomout', label: 'Zoom Out' }, { id: 'fullscreen', label: 'Full Screen' }] },
      { label: 'Help', items: [{ id: 'docs', label: 'Documentation' }, { id: 'about', label: 'About' }] },
    ],
  });
}
...
function StepperDemo() {
  ...
  return createElement('div', null,
    ...
    createElement(FlexContainer, { gap: '8px', style: { marginTop: '12px' } },
      createElement(Button, { onClick: () => setCurrent(Math.max(0, current - 1)), disabled: current === 0 }, 'Back'),
      createElement(Button, { onClick: () => setCurrent(Math.min(3, current + 1)), disabled: current === 3, variant: 'primary' }, 'Next'),
    ),
  );
}
        ...
        id: 'root', label: 'Project', children: [
          ...
          { id: 'tests', label: 'tests', children: [
            { id: 'unit', label: 'unit', children: [
              { id: 'test1', label: 'Button.test.ts' },
            ]},
          ]},
        ],
      },
    }),
    selected ? createElement('p', { style: { fontSize: '11px', color: '#3b82f6', marginTop: '6px' } }, `Selected: ${selected}`) : null,
  );
}
...
function VirtualScrollDemo() {
  ...
  return createElement('div', null,
    createElement(VirtualScroll, {
      ...
      itemHeight: 28,
      height: '120px',
      renderItem: (item: unknown) => createElement('div', { style: { padding: '4px 12px', fontSize: '13px', borderBottom: '1px solid #f1f5f9', display: 'flex', alignItems: 'center', height: '28px' } }, item as string),
    }),
    createElement('p', { style: { fontSize: '11px', color: '#94a3b8', marginTop: '4px' } }, 'Rendering only visible items of 1000 total'),
  );
}
...
function DigitalClockDemo() {
  ...
  return createElement('div', null,
    createElement('div', { style: { display: 'flex', gap: '6px', marginBottom: '10px', flexWrap: 'wrap' } },
      createElement(Button, { onClick: () => setFormat('12h'), size: 'sm', active: format === '12h' }, '12h'),
      createElement(Button, { onClick: () => setFormat('24h'), size: 'sm', active: format === '24h' }, '24h'),
      createElement(Button, { onClick: () => setShowDate(!showDate), size: 'sm', active: showDate }, 'Date'),
      createElement(Button, { onClick: () => setDateFormat('short'), size: 'sm', active: dateFormat === 'short' }, 'Short'),
      createElement(Button, { onClick: () => setDateFormat('long'), size: 'sm', active: dateFormat === 'long' }, 'Long'),
      createElement(Button, { onClick: () => setDateFormat('iso'), size: 'sm', active: dateFormat === 'iso' }, 'ISO'),
    ),
...
function AnalogClockDemo() {
  ...
  return createElement('div', null,
    createElement(FlexContainer, { gap: '6px', style: { marginBottom: '10px', flexWrap: 'wrap' } },
      createElement(Button, { onClick: () => setFormat('12h'), size: 'sm', active: format === '12h' }, '12h'),
      createElement(Button, { onClick: () => setFormat('24h'), size: 'sm', active: format === '24h' }, '24h'),
      createElement(Button, { onClick: () => setShowSeconds(!showSeconds), size: 'sm', active: showSeconds }, 'Seconds'),
      createElement(Button, { onClick: () => setShowDate(!showDate), size: 'sm', active: showDate }, 'Date'),
    ),
...
function FlexContainerDemo() {
  ...
  return createElement('div', null,
    createElement('div', { style: { display: 'flex', gap: '6px', marginBottom: '8px' } },
      createElement(Button, { onClick: () => setDirection('row'), size: 'sm', active: direction === 'row' }, 'Row'),
      createElement(Button, { onClick: () => setDirection('column'), size: 'sm', active: direction === 'column' }, 'Column'),
    ),
    createElement(FlexContainer, { direction, gap: '8px', style: { padding: '12px', background: '#f8fafc', borderRadius: '6px', border: '1px solid #e2e8f0' } },
...
function GridDemo() {
  return createElement(Grid, { columns: 3, gap: '8px' },
...
function PanelDemo() {
  return createElement(Panel, { title: 'Panel Header', collapsible: true, bordered: true },
    createElement('div', { style: { fontSize: '13px', color: '#64748b' } }, 'Panel content area. Click the header to collapse.'),
  );
}

function ScrollContainerDemo() {
  return createElement(ScrollContainer, { maxHeight: '100px', direction: 'vertical' },
    ...Array.from({ length: 12 }, (_, i) =>
      createElement('div', { key: String(i), style: { padding: '4px 12px', fontSize: '13px', lineHeight: '1.8' } }, `Scrollable item ${i + 1}`),
    ),
  );
}

function SplitterDemo() {
  return createElement(Splitter, { direction: 'horizontal', initialSplit: 50, style: { height: '80px', border: '1px solid #e2e8f0', borderRadius: '6px', overflow: 'hidden' } },
    createElement('div', { style: { background: '#eff6ff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '12px', color: '#3b82f6', fontWeight: '600', height: '100%' } }, 'Left'),
    createElement('div', { style: { background: '#f0fdf4', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '12px', color: '#16a34a', fontWeight: '600', height: '100%' } }, 'Right'),
  );
}
...
function TabsLayoutDemo() {
  ...
  return createElement(Tabs, {
    ...
    variant: 'card',
    tabs: [
      { id: 'content', label: 'Content', content: createElement('div', { style: { padding: '14px', fontSize: '13px', color: '#64748b' } }, 'Layout region: Content') },
      { id: 'sidebar', label: 'Sidebar', content: createElement('div', { style: { padding: '14px', fontSize: '13px', color: '#64748b' } }, 'Layout region: Sidebar') },
      { id: 'footer', label: 'Footer', content: createElement('div', { style: { padding: '14px', fontSize: '13px', color: '#64748b' } }, 'Layout region: Footer') },
    ],
  });
}
...
function CartesianRoseDemo() {
  ...
  return createElement('div', null,
    createElement(CartesianGraph2D, {
      width: 220, height: 180, points,
      xRange: [-1.2, 1.2], yRange: [-1.2, 1.2],
      showGrid: true, showAxes: true,
      pointRadius: 2, pointColor: '#3b82f6', curveColor: '#3b82f6',
    }),
...
function formField(label: string, value: string, onChange: (v: string) => void, error: string | undefined, type: string, placeholder: string) {
  return createElement(TextField, { label, value, onChange, error, type: type as 'text', placeholder });
}

function formToggleRow(label: string, on: boolean, onClick: () => void) {
  return createElement(Toggle, { checked: on, onChange: () => onClick(), label });
}
...
function SignUpFormDemo() {
  ...
  return createElement('div', { style: { display: 'flex', flexDirection: 'column', gap: '12px' } },
    ...
    createElement(Button, { onClick: handleSubmit, variant: 'primary' }, 'Sign Up'),
  );
}
...
function SearchSuggestionsDemo() {
  ...
  return createElement('div', null,
    createElement(TextField, {
      value: query,
      onChange: (v: string) => { setQuery(v); setSelected(''); },
    ...
    matches.length > 0 && !selected
      ? createElement(ListView, {
          items: matches,
          keyExtractor: (item: unknown) => item as string,
          renderItem: (item: unknown) => createElement('span', { style: { fontSize: '13px' } }, item as string),
          onSelect: (idx: number) => { setSelected(matches[idx]!); setQuery(matches[idx]!); },
          hoverable: true,
          divider: true,
        })
      : null,
...
function MultiStepWizardDemo() {
  ...
  return createElement('div', null,
    ...
    createElement('div', { style: { textAlign: 'center', padding: '16px 0', fontSize: '14px', color: '#64748b' } },
      `Step ${step + 1} content area`,
    ),
    createElement(FlexContainer, { gap: '8px', justifyContent: 'center' },
      step > 0
        ? createElement(Button, { onClick: () => setStep(step - 1) }, 'Back')
        : null,
      step < 2
        ? createElement(Button, { onClick: () => setStep(step + 1), variant: 'primary' }, 'Next')
        : createElement(Button, { onClick: () => setStep(0), style: { backgroundColor: '#16a34a', color: 'white', border: 'none' } }, 'Finish'),
    ),
  );
}
...
function TimeSeriesDemo() {
  ...
  return createElement(LineGraph, {
    ...
    showPoints: true, showGrid: true, showArea: true,
    lineColor: '#3b82f6', areaColor: 'rgba(59,130,246,0.1)',
...
function HistogramDemo() {
  return createElement(Histogram, {
    data: [12, 15, 22, 28, 35, 42, 45, 50, 55, 58, 62, 65, 68, 72, 75, 78, 80, 82, 85, 88, 90, 92, 38, 48, 52, 55, 60, 63, 67, 70],
    bins: 10,
...
function BoxPlotDemo() {
  return createElement(BoxPlot, {
    data: [
      { label: 'Q1', values: [35, 42, 48, 52, 55, 58, 62, 65, 68, 72, 78, 85, 120] },
      { label: 'Q2', values: [40, 45, 50, 55, 60, 65, 68, 70, 72, 75, 80, 88] },
      { label: 'Q3', values: [30, 38, 42, 48, 52, 55, 58, 60, 62, 65, 70] },
    ],
    width: 260, height: 140,
    showOutliers: true, showMean: true, showGrid: true,
  });
}
...
function WaterfallDemo() {
  return createElement(WaterfallChart, {
    ...
    width: 280, height: 160,
    showValues: true, showConnectors: true, showGrid: true,
  });
}
...
function GaugeDemo() {
  return createElement(Gauge, {
    ...
    showValue: true, showMinMax: true, showTicks: true,
    tickCount: 5,
    label: 'Performance',
    unit: '%',
...
function RadarDemo() {
  return createElement(RadarChart, {
    axes: [
      { label: 'Speed' }, { label: 'Power' }, { label: 'Range' },
      { label: 'Defense' }, { label: 'Accuracy' }, { label: 'Agility' },
    ],
    series: [
    ...
    showLabels: true, showDots: true, showLegend: true,
  });
}
...
function WordCloudDemo() {
  return createElement(WordCloud, {
    words: [
      { text: 'SpecifyJS', weight: 100 }, { text: 'TypeScript', weight: 80 },
      { text: 'Components', weight: 70 }, { text: 'SVG', weight: 60 },
      { text: 'Rendering', weight: 55 }, { text: 'Hooks', weight: 50 },
      { text: 'Router', weight: 45 }, { text: 'State', weight: 40 },
      { text: 'Virtual DOM', weight: 38 }, { text: 'Context', weight: 35 },
      { text: 'Effects', weight: 30 }, { text: 'Refs', weight: 28 },
      { text: 'Memo', weight: 25 }, { text: 'Lazy', weight: 22 },
      { text: 'Portal', weight: 20 }, { text: 'Suspense', weight: 18 },
    ],
    width: 260, height: 160,
    minFontSize: 10, maxFontSize: 36,
...
function HeatMapDemo() {
  return createElement(HeatMap, {
    ...
    width: 280, height: 160,
    showValues: true, title: 'Activity',
  });
}
...
function MatrixDemo() {
  return createElement(Matrix, {
    ...
    showValues: true, symmetric: true,
    title: 'Correlation',
  });
}
    ...
    data: {
      label: 'Total', children: [
        { label: 'A', value: 40, children: [
          { label: 'A1', value: 25 }, { label: 'A2', value: 15 },
        ]},
        { label: 'B', value: 35, children: [
          { label: 'B1', value: 20 }, { label: 'B2', value: 15 },
        ]},
        { label: 'C', value: 25 },
      ],
    },
...
function SankeyDemo() {
  return createElement(SankeyDiagram, {
    nodes: [
      { id: 'a', label: 'Source A' }, { id: 'b', label: 'Source B' },
      { id: 'c', label: 'Process' },
      { id: 'd', label: 'Output X' }, { id: 'e', label: 'Output Y' },
    ],
    links: [
...
function DecompositionTreeDemo() {
  return createElement(DecompositionTree, {
    data: {
      label: 'Revenue', value: '$10M', children: [
        { label: 'Product', value: '$6M', children: [
          { label: 'SaaS', value: '$4M' },
          { label: 'License', value: '$2M' },
        ]},
        { label: 'Services', value: '$4M', children: [
...
function GeoMapDemo() {
  ...
  const regionsWithValues = regions.map((r, i) => ({ ...r, value: 20 + i * 8 }));
